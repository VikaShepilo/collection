...
class Information
{
    ...
    public function getOneCollection(): ?Collections
    {
        return $this->one_collection;
    }

    public function setOneCollection(Collections $one_collection): self
    {
        $this->one_collection = $one_collection;
